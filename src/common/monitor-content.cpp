...
void MonitorContent::updateMonitorInfo(qint64 nodeId)
{
    m_nodeId = nodeId;
    InfoWorker::getInstance().monitorHistory(nodeId, m_xStart.toSecsSinceEpoch(), m_xEnd.toSecsSinceEpoch(), m_xInterval, m_containerId);  //10 minute
}
