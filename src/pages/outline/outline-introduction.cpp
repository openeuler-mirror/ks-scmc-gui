                                                            ...
                                                            ui(new Ui::OutlineIntroduction)
{
    ...
    ui->label_summary->setText(tr("Security container platform"));
    ui->label_body->setText(tr("KylinSec container management system is built on the domestic Linux system to realize the self-developed security container platform. It provides \n"
