...
void NetworkAccessCtlTab::initUI()
{
    ...
    textBrowser->setHtml("<div id='u1490_text' class='text '>"
                         ...
                         "<p style='font-size:14px;'><span style='font-size:12px;font-weight:400;'>当访问状态为开启时，才可以对网络协议和网络地址进行编辑、修改、删除；</span></p>"
                         "<p style='font-size:14px;'><span style='font-size:12px;font-weight:400;'>当访问状态为关闭状态时，网络协议和网络地址组件都为禁用状态。</span></p>"
