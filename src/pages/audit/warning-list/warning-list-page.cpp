...
void WarningListPage::createSubPage(WarningListPageType type)
{
    ...
    case CONTAINER_WARNING:
    {
        ...
        connect(m_warninglistview_container, &WarningListView::sigUpdateWaringSums, this, &WarningListPage::sigUpdateWaringSums);
    ...
    case NODE_WARNING:
    {
        ...
        connect(m_warninglistview_node, &WarningListView::sigUpdateWaringSums, this, &WarningListPage::sigUpdateWaringSums);
