...
QPair<grpc::Status, node::GetFileProtectReply> Node::_getFileProtect(const node::GetFileProtectRequest &req)
{
    RPC_IMPL(node::GetFileProtectReply, node::Node::NewStub, GetFileProtect);
}
