...
LicenseActivation::LicenseActivation(QWidget *parent) : KiranTitlebarWindow(parent),
                                                        ...
                                                        m_qrcodeDialog(nullptr)
{
    ...
    connect(m_ui->m_cancel, &QPushButton::clicked, this, &LicenseActivation::close);
...
void LicenseActivation::activate()
{
    ...
    KiranMessageBox::message(nullptr, tr("Activation"), message, KiranMessageBox::KiranStandardButton::Ok);
}
